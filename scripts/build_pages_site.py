...
REDIRECTS = {
    ...
    "payoff-ratio/index.html": ("tab-payoff-ratio", "Payoff Ratio"),
    "odds/index.html": ("tab-payoff-ratio", "Payoff Ratio"),  # legacy slug → renamed tab
...
def refresh_snapshot(ticker: str = DEMO_TICKER) -> dict:
    ...
    # Deterministic fixtures first (expiry calendar + probability demo table).
...
def assemble(out_dir: Path, ticker: str = DEMO_TICKER) -> Path:
    ...
    # auto-load tab handlers (option chain / payoff ratio / sim) work on first click,
