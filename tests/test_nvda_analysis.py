...
class TestFeaturesDF:
    ...
    def test_good_data_produces_nonempty_features(self, _patch_downloads):
        ...
        assert set(analyzer.features_df.columns) == {
            'Oscillation', 'Osc_high', 'Osc_low', 'Returns', 'Difference'
        }
...
class TestFlaskAnalysisPost:
    ...
    def test_nvda_post_returns_charts(self, client):
        ...
        assert 'data:image/png;base64,' in html, (
            'Expected base64 chart image in response HTML'
        )
    ...
    def test_analysis_service_direct(self, _patch_downloads):
        ...
        chart_keys = [
            'feat_ret_scatter_top_url', 'high_low_scatter_url',
            'return_osc_high_low_url', 'volatility_dynamic_url',
        ]
