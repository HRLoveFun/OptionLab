...
class TestTickerNormalisationForFutu:
    ...
    def test_normalize_produces_futu_ticker(self, raw, expected_futu):
        ...
        assert futu == expected_futu, f"normalize_ticker({raw!r}) returned futu={futu!r}, expected {expected_futu!r}"
    ...
    def test_futu_ticker_is_futu_format(self, raw):
        ...
        assert is_futu_format(futu), f"normalize_ticker({raw!r}) returned futu={futu!r} which is_futu_format() rejects"
...
class TestOptionChainRouteFutuFormat:
    ...
    def test_yahoo_ticker_converted_to_futu(self, mock_refresh, client):
        ...
        with patch(
            ...
            assert call_ticker == "US.NVDA", f"get_option_chain_futu called with {call_ticker!r} instead of 'US.NVDA'"
...
class TestOptionsChainAnalyzerFutuInit:
    ...
    def test_yahoo_ticker_converted_in_init(self):
        ...
        with patch(
            ...
            call_ticker = mock_futu.call_args[0][0]
            assert call_ticker == "US.NVDA", (
                f"_init_from_futu called futu provider with {call_ticker!r}, expected 'US.NVDA'"
            )
...
class TestMarketAnalyzerFeaturesNotEmpty:
    ...
    def test_features_not_empty_two_month_daily(self):
        ...
        assert len(analyzer.features_df) >= 20, f"Expected >=20 rows for 2-month daily, got {len(analyzer.features_df)}"
