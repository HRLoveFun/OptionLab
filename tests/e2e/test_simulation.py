...
def test_simulation_open_input_render(page: Page, live_server: str, js_errors: list[str], open_tab) -> None:
...
@pytest.mark.usefixtures("mock_apis")
def test_simulation_dual_iv_unlinked(page: Page, live_server: str, js_errors: list[str], open_tab) -> None:
