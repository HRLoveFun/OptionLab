...
def test_assemble_matches_flask_partials(tmp_path):
    ...
    for rel in ("static/styles.css", "static/main.js", "static/option-chain.js",
                "static/sim/grid.js", "static/state/store.js"):
...
def test_snapshot_schema():
    ...
    for name in ("market_review_ts.nvda.json", "validate_tickers.json",
                 "regime_current.json", "regime_history.json",
