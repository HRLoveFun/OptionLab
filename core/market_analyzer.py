"""Market Analyzer — BACKWARD-COMPAT ADAPTER over core.market.*.

This module is a thin facade.  All heavy lifting has been moved to:
  - core.market.data_context   (data fetching)
  - core.market.features       (pure computation)
  - core.market.projections    (walk-forward projection)
  - core.market.charts         (matplotlib rendering)
  - core._shared.plotting      (figure lifecycle)

New code should import those submodules directly; this class exists only
to satisfy existing callers in services/ and tests/ during the transition.
"""
...
class MarketAnalyzer:
    """High-level market analysis — now a thin orchestrator over core.market submodules."""
